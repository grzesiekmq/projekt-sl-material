        ...
        db.transaction(function(tx) {
            tx.executeSql('SELECT * FROM sl', [], function(tx, res) {
                for (var i = 0; i < res.rows.length; i++) {
                    ...
                    lv.append("<li class='mdl-list__item'><span class='mdl-list__item-primary-content'><span>" + getProduct + "</span></span><span class='mdl-list__item-secondary-content'><button class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent material-icons c'>close</button></span></li>");
                    $('.material-icons.c').click(function() {

                        $(this).closest('li').remove();
                    });
        // dodaje do historii
        lvh.append("<li class='mdl-list__item'><span class='mdl-list__item-primary-content'><span>" + getProduct + "</span></span><span class='mdl-list__item-secondary-content'>" + customDate + "</span></li>");
        ...
        db.transaction(function(tx) {
            tx.executeSql('SELECT * FROM sl', [], function(tx, res) {
                for (var i = 0; i < res.rows.length; i++) {
                    ...
                    // dodaje do listy wybrany produkt
                    lv.append("<li class='mdl-list__item'><span class='mdl-list__item-primary-content'><span>" + getProduct + "</span></span><span class='mdl-list__item-primary-content'>" + getBonus + "</span><span class='mdl-list__item-secondary-content'><button class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent material-icons c'>close</button></span></li>");
                    $('.material-icons.c').click(function() {
